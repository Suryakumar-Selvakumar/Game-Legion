...
class Sidebar extends Component {
  ...
  render() {
    return (
      <FocusTrap
        active={this.state.isMobileView ? true : false}
        focusTrapOptions={{
      ...
      >
        <StyledSidebar
          role="menu"
          aria-label={this.state.isMobileView ? "Filter menu" : "Sidebar menu"}
          className={!this.props.isSideBarVisible ? "close" : ""}
        >
          <Category role="group" aria-labelledby="games-heading">
            ...
            >
              <MenuIcon
                ...
                style={{
                  backgroundColor:
                    this.props.pageState === "Wishlist" && "white",
                }}
              >
                <svg
                  viewBox="0 0 16 16"
          ...
          <Category role="group" aria-labelledby="releases-heading">
            <h2 id="releases-heading">New Releases</h2>
            <MenuButton
            ...
            >
              ...
              >
                <svg
                  ...
                  viewBox="-4 0 26 26"
                  fill={
                    this.props.pageState === "This week" ? "black" : "white"
                  }
                >
            ...
            >
              ...
              >
                <svg
                  ...
                  viewBox="0 0 20 16"
                  fill={
                    this.props.pageState === "Next week" ? "black" : "white"
                  }
                >
          ...
          <Category role="group" aria-labelledby="top-heading">
            ...
            >
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  fill={
                    this.props.pageState === "Popular in 2026"
                      ? "black"
                      : "white"
                  }
                >
	...
	c11.133,0,20.158-9.025,20.158-20.158C256,68.262,246.975,59.236,235.842,59.236z"
          ...
          <Category aria-labelledby="platforms-heading" role="group">
            ...
            >
              ...
              >
                <svg
                  ...
                  viewBox="0 0 21 16"
                  fill={
                    this.props.pageState === "Nintendo Switch"
                      ? "black"
                      : "white"
                  }
                >
            ...
            >
              <MenuIcon
                ...
                style={{
                  backgroundColor:
                    this.props.pageState === "Android" && "white",
                }}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <Category aria-labelledby="genres-heading" role="group">
            ...
            >
              <MenuIcon
                ...
                style={{
                  backgroundColor:
                    this.props.pageState === "Strategy" && "white",
                }}
              >
                <svg
                  version="1.1"
            ...
            >
              <MenuIcon
                ...
                style={{
                  backgroundColor:
                    this.props.pageState === "Shooter" && "white",
                }}
              >
                <svg
                  version="1.1"
            ...
            >
              ...
              >
                <svg
                  ...
                  xmlSpace="preserve"
                  fill={
                    this.props.pageState === "Adventure" ? "black" : "white"
                  }
                >
                  <g>
                    <g>
...
q-14 9 -19 12q-9 5 -14 5t-12 -7q-5 -5 -16 -18q-30 -35 -53 -51q-41 -28 -89 -28zM464 937h-1h1z"
            ...
            >
              ...
              >
                <svg
                  fill={
                    this.props.pageState === "Simulation" ? "black" : "white"
                  }
                  viewBox="0 0 56 56"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            >
              ...
              >
                <svg
                  ...
                  xmlSpace="preserve"
                  fill={
                    this.props.pageState === "Platformer" ? "black" : "white"
                  }
                >
                  <g strokeWidth="0"></g>
                  <g strokeLinecap="round" strokeLinejoin="round"></g>
            ...
            >
              <MenuIcon
                ...
                style={{
                  backgroundColor:
                    this.props.pageState === "Fighting" && "white",
                }}
              >
                <svg
                  version="1.1"
